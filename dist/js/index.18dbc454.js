...
var tlMain = (0, _gsap.gsap).timeline({
    scrollTrigger: {
        trigger: ".slider-mask",
        start: "top top",
        end: "2000%",
        ...
        scrub: 1,
        onComplete: ()=>{
            if (lock1) // Si le verrou 1 est actif
...
tlMain.to(".slider-track", {
    ...
    ease: "power1.inOut",
    onComplete: ()=>{
        if (lock2) // Si le verrou 2 est actif
        html.style.overflow = "hidden"; // Le scroll est bloqué
    }
});
tlMain.to({}, {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jQVXF","1SICI"], "1SICI", "parcelRequire0300")
